    ...
    return(
        <AboutWrapper id="about" ref={ref} className="first">
            <div className="content" id="gsap-logo">
                ...
                <p className="second-paragraph">At our gym, we offer top-notch instruction from experienced and highly skilled trainers (2 x black belt instructors). Our curriculum is designed to cater to students of all skill levels, from first timers to advanced practitioners. Whether you are looking to compete or simply want to improve your fitness, we have something for you.</p>
